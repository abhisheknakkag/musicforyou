...
<br>
  ...
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> krusweil keyboard</h2>   
 
  <table>
  <tr>
  <td> 
   <img  src="img2/krusweilkeys.jpg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.46000</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.50000</span></p>
...
<br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" > Krusweil keyboard.</p>
     <br>
    <br>
