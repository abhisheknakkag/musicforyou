...
<br>
  ...
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> yamaha keyboard</h2>   
 
  <table>
  <tr>
  <td> 
   <img  src="img2/yamaha motif.jpg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.48000</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.52000</span></p>
...
<br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" > yamaha keyboard.</p>
     <br>
    <br>
